        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-2 sm:grid-cols-3">
            <div className="rounded-3xl bg-slate-50 p-4 text-center">
              <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">{labels.duration}</p>
              <p className="mt-2 text-xl font-semibold text-slate-900">{currentStep.duration ?? 0}s</p>
            </div>
            <div className="rounded-3xl bg-slate-50 p-4 text-center">
              <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">{labels.elapsed}</p>
              <p className="mt-2 text-xl font-semibold text-slate-900">{stepSeconds}s</p>
            </div>
            <div className="rounded-3xl bg-slate-50 p-4 text-center">
              <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">{labels.remaining}</p>
          ...
          {currentStep.notes && (
            <div className="rounded-3xl bg-slate-100 p-4 text-slate-700">
              ...
              <p className="mt-2 text-sm leading-5">{currentStep.notes[labels.langKey]}</p>
            </div>
          )}
