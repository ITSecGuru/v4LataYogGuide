    ...
    <div className="rounded-3xl bg-white p-5 shadow-soft">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-600">{routine.description[labels.langKey]}</p>
        </div>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-3xl bg-slate-50 p-4">
          ...
          <p className="mt-2 text-lg font-semibold text-slate-900">{currentStep ? currentStep.deva : labels.noStep}</p>
        ...
        <div className="rounded-3xl bg-slate-50 p-4">
          ...
          <p className="mt-2 text-3xl font-semibold text-cyan-600">{Math.round(progress)}%</p>
